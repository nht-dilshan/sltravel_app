...
class AllForestScreen extends StatefulWidget {
  @override
  _AllForestScreenState createState() => _AllForestScreenState();
}

class _AllForestScreenState extends State<AllForestScreen> {
  Future<List<Map<String, String>>> fetchForests() async {
    final String response = await rootBundle.loadString('lib/assets/places.json');
    final data = await json.decode(response);
    return List<Map<String, String>>.from(data['forests']);
  }
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Stack(
                            ...
                            children: [
                              Image.asset(
                                forest['image'] ?? 'lib/assets/placeholder.jpg',
                                fit: BoxFit.cover,
                              ),
                              Container(
                                decoration: BoxDecoration(

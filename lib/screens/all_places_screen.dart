...
class _AllPlacesScreenState extends State<AllPlacesScreen> {
  final places = [
    ...
    },
    {
      'name': 'Unawatuna',
      'description':
          'Good choice for families, this beach is accessible by a small road lined with shops and restaurants.',
      'image': 'lib/assets/Unawatuna.jpg'
    },
    {
      'name': 'Godawaya',
      'description':
          'A calm beach with a small fishing harbor. Quite nice in the morning because the sailors are coming back from the sea.',
      'image': 'lib/assets/godawaya.jpg'
    },
    {
      'name': 'Ussangoda',
      'description':
          'Very ancient scenic beach. Very beautiful location near Nonagama town. Location can be accessed via vehicle. Very nice environment.',
      'image': 'lib/assets/ussangoda.jpg'
    },
    {
      'name': 'Tangalle Beach',
      'description':
          'Tangalla beach is also the most attractive beach among local and foreign tourists. A coral reef has distributed along the coastal area and as well as rocky shore.',
    ...
    },
    {
      ...
      'description':
          "Theravada Buddhism is a school of Buddhism that originated in India around 500 B.C. and is considered to be the oldest existing school of Buddhism.\n\n  The name Theravada means 'the doctrine of the elders' or 'the way of the elders' in Pali, the sacred language of the school. Theravada Buddhism is practiced in many countries, including: Cambodia, Laos, Myanmar (Burma), Sri Lanka, and Thailand.",
      'image': 'lib/assets/theravada buddhism.jpg'
    },
    {
      'name': 'Sinharaja Forest',
      'description':
          'SINHARAJA RAIN FOREST is a world heritage and bio diversity hotspot which is also a major eco tourism destination in Sri Lanka.',
    ...
    },
    {
      'name': 'Riverstone',
      'description':
          'Travelling further upstream on this very scenic stream will no doubt will make you feel refreshed and rejuvenated.',
